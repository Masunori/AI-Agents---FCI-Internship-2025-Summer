...
IRRELEVANT_DOCS = [
    Document(
        ...
        published_date=datetime.fromisoformat("2025-12-18"),
        content_type="paper"
    ),
    Document(
        ...
        published_date=datetime.fromisoformat("2025-12-12"),
        content_type="paper"
    ),
    Document(
        ...
        published_date=datetime.fromisoformat("2024-12-13"),
    ...
    Document(
        ...
        published_date=datetime.fromisoformat("2024-11-25"),
        content_type="article"
    ),
    Document(
        ...
        published_date=datetime.fromisoformat("2025-12-15"),
        content_type="article"
    ),
    Document(
    ...
    Document(
        ...
        authors=["Jianfei Hu"],
        published_date=datetime.fromisoformat("2025-12-16"),
        content_type="article"
    ),
    Document(
        ...
        authors=[],
        published_date=datetime.fromisoformat("2024-06-01"),
        content_type="article"
    ),
    Document(
    ...
    Document(
        ...
        published_date=datetime.fromisoformat("2025-12-23"),
        content_type="article"
    ),
    Document(
...
RELEVANT_DOCS_CLOUD = [
    Document(
        ...
        published_date=datetime.fromisoformat("2024-07-09"),
        content_type="article"
    ),
    Document(
        ...
        published_date=datetime.fromisoformat("2023-09-27"),
        content_type="article"
    ),
    # Document(
    ...
    Document(
        ...
        published_date=datetime.fromisoformat("2025-12-02"),
        content_type="article"
    )
]
...
RELEVANT_DOCS_AI = [
    ...
    Document(
        ...
        published_date=datetime.fromisoformat("2025-02-25"),
        content_type="paper"
    ),
    Document(
    ...
    Document(
        ...
        published_date=datetime.fromisoformat("2025-09-26"),
        content_type="paper"
    ),
    Document(
...
RELEVANT_DOCS_SECURITY = [
    Document(
        ...
        published_date=datetime.fromisoformat("2025-12-04"),
        content_type="article"
    ),
    Document(
        ...
        authors=[],
        published_date=datetime.fromisoformat("2025-11-04"),
        content_type="article"
    )
]
...
RELEVANT_DOCS_DATA = [
    ...
    Document(
        ...
        published_date=datetime.fromisoformat("2025-12-08"),
        content_type="article"
    ),
    Document(
        ...
        published_date=datetime.fromisoformat("2025-12-11"),
        content_type="article"
    ),
    Document(
...
RELEVANT_DOCS_AI_ETHICS = [
    Document(
        ...
        published_date=datetime.fromisoformat("2024-08-12"),
        content_type="article"
    ),
    Document(
        ...
        published_date=datetime.fromisoformat("2025-04-10"),
        content_type="article"
    )
]
